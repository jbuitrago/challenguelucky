...
```
## Configurar variables de conexion a Postgres

```bash
De momento por un problema que tuve con dotenv se deja hardcodeado en :
src/db/db.modules.ts
...
```bash
# importar a postman el file
lucky.postman_collection.json
